...
def trackanddisplay(
    ...
    pointlists = {}
    model = csrt.CSRTMultiple()  # require re-initialization per-sequence
...
if __name__ == "__main__":
    ...
    for ind, dataset in enumerate(datasets[:num_data]):
        try:
            ...
            for modeltype, result in endres.items():
                # result is a list
    ...
    import json
    with open(f'results/{errortype}{num_data_name}{args.jsonsuffix}.json', 'w') as fp:
